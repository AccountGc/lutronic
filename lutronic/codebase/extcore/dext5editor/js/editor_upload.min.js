function uploadAjaxOnprogressStart(a,c){var d={};DEXTTOP.G_CURREDITOR.xhr_onprogress=new XMLHttpRequest;var b=DEXTTOP.G_CURREDITOR.xhr_onprogress;DEXTTOP.DEXT5.ajax.xhrWithCredentials&&"withCredentials"in b&&(b.withCredentials=!0);b.upload.onprogress=function(a){try{if(!DEXTTOP.G_CURREDITOR.imageFileInfo.isMulti){var b=DEXTTOP.DEXT5.util.parseIntOr0(a.loaded/a.total*100),c=document.getElementById("dext_loading");c&&c.childNodes&&(c.childNodes[1].nodeValue=" Uploading... "+b+"%")}}catch(d){loading_image_show(!1)}};
b.onload=function(){if(b){var a;200==b.status?(d.response=DEXTTOP.G_CURREDITOR._FRAMEWIN.getXhrResponseData(),a=b.responseText,a=web_url_remove_char(a)):(d.response=DEXTTOP.G_CURREDITOR._FRAMEWIN.getXhrResponseData(b),a="[FAIL]File Upload Error");b=null;DEXTTOP.G_CURREDITOR.imageFileInfo.isMulti||loading_image_show(!1);c(a,d)}};b.onerror=function(){d.response=DEXTTOP.G_CURREDITOR._FRAMEWIN.getXhrResponseData(b);b=null;DEXTTOP.G_CURREDITOR.imageFileInfo.isMulti||loading_image_show(!1);c("[FAIL]File Upload Error",
d)};var e=new FormData;a.formData&&0<a.formData.length&&a.formData.each(function(a,b){"proxy_url"==a&&(b="0"!=DEXTTOP.G_CURREDITOR._config.security.encryptParam?DEXTTOP.DEXT5.util.makeEncryptParamFinal(""):"");e.append(a,b)});if(a.fileObj){var f=a.fileObj[0]?a.fileObj[0]:a.fileObj,g="1"==DEXTTOP.G_CURREDITOR._config.uploadFileNameEncoding?encodeURIComponent(f.name):f.name;e.append(a.fileID,f,g)}b.open("POST",a.handlerUrl,!0);DEXTTOP.DEXT5.util.setAddHttpHeader(b,DEXTTOP.G_CURREDITOR._config.addHttpHeader);
b.send(e)}function uploadAjaxOnprogressCancel(){if(DEXTTOP.G_CURREDITOR.xhr_onprogress)try{DEXTTOP.G_CURREDITOR.xhr_onprogress.abort(),DEXTTOP.G_CURREDITOR.xhr_onprogress=null}catch(a){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(a)}}
