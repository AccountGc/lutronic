...
var arrSearchWordMenu = [
    ...
    [
        [
            ...
            ['Event.ApplyFontStyle', 'dext_editor_apply_font_style_event를 설정', '폰트 스타일(fontFamily, fontSize, lineHeight) 적용 시 발생합니다.'],
            ...
            ['DefaultImemode', 'IE 브라우저에서 에디터 로드시 한글입력으로 로드하도록 설정'],
        ...
        [
            ...
            ['ApplyFontStyle', '폰트 스타일(fontFamily, fontSize, lineHeight) 적용 시 발생합니다.']
        ]
    ],
    [
        ['기본 에디터 생성'],
