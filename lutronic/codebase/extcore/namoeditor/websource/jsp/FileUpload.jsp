			...
			while(iter.hasNext()){
				...
				if(fileItem.isFormField()){          
					...
					if(fileItem.getSize()>0) {   
						...
						if (filename.toLowerCase().indexOf(".") == -1 || filename.toLowerCase().indexOf(".jar") != -1 || filename.toLowerCase().indexOf(".war") != -1 || filename.toLowerCase().indexOf(".jsp") != -1 || filename.toLowerCase().indexOf(".php") != -1 || filename.toLowerCase().indexOf(".jspx") != -1 || filename.toLowerCase().indexOf(".js") != -1 || filename.toLowerCase().indexOf(".html") != -1 || filename.toLowerCase().indexOf(".htm") != -1 || filename.toLowerCase().indexOf(".htaccess") != -1) {
