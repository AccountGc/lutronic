...
<%
	...
	{	
			...
			{
				session.invalidate(); 
				result_sc = "<script>alert(NamoSELang.pe_Fk);window.document.location.href='../index.html';</script>";
			}
			else
			{
		...
		result_sc = "<script>alert(NamoSELang.pe_Hf);location.href='account_setting.jsp';</script>";
	}
