...
<%
	...
	if (settingValue.get("UploadImageFileExtBlockList") == null|| settingValue.get("UploadImageFileExtBlockList") == "") settingValue.put("UploadImageFileExtBlockList", "0|gif,jpeg,jpg,png,bmp,webp");
...
<title>Namo CrossEditor : Admin</title>
	<script type="text/javascript">var pe_Fa="pe_aaC"; </script>
...
<form method="post" id="adminSetForm" name="adminSetForm" action="manager_proc.jsp" onsubmit="return pe_bK();">
			...
			<td class="pe_mZ">
				...
				<table id="Info">
					<tr>
						...
						<font style="font-size:14pt;color:#3e77c1;font-weight:bold;text-decoration:none;"><span id="pe_PY"></span></font></td>
				...
				<table class="pe_rs">
					<tr>
						<td class="pe_baG">				
							<ul>
								<li class="pe_oJ pe_Wy"><input type="button" id="setting_base" value="" style="width:110px;height:28px;" class="pe_zs pe_iR" /></li>
								<li class="pe_oJ"><input type="button" id="setting_edit" value="" style="width:110px;height:28px;" class="pe_zs pe_iR" /></li>
								<li class="pe_oJ"><input type="button" id="setting_view" value="" style="width:110px;height:28px;" class="pe_zs pe_iR" /></li>
								<li class="pe_oJ"><input type="button" id="setting_ab" value="" style="width:110px;height:28px;" class="pe_zs pe_iR" /></li>
							</ul>
						
						</td>
					</tr>
					<tr>
						<td class="pe_pW pe_ne"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Qw"></span></font></td>
					</tr>
				</table>
			...
			<td class="pe_mZ">
				<div id="pe_awm">
					<table class="pe_BM">
						<tr>
							<td>
								<table class="pe_hk"><tr><td class="pe_kU" colspan="3"></td></tr>
								</table>
								...
								<table class="pe_hk">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_PA"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_PX"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Mb"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<input type="text" id="ImageSavePath" class="pe_pm" name="ImageSavePath" value="<%=settingValue.get("ImageSavePath")%>" /> ex) http:// www.mysite.com/image
										</td>
									</tr>
									...
									<div id="pe_aCT">
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Lz"></span></b></td>
										<td class="pe_eX"></td>
										<td >
											<table class="pe_hk">
												<tr>
													<td class="pe_fc"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_afw" value="real" /><span id="pe_Oh"></span>
												...
												<tr>
													<td class="pe_fc"> &nbsp;&nbsp;
													<input type="radio" name="encodingStyle" id="pe_awW" value="trans" /><span id="pe_Mg"></span>
													</td>
												</tr>
												<tr>
													<td class = "pe_dU" colspan="3"></td>
												...
												<tr>
													<td class="pe_fc"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_aws" value="random" /><span id="pe_Ti"></span>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_QH"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc"> &nbsp;
											<input type="hidden" id="UploadFileSubDir" name ="UploadFileSubDir" value="<%=settingValue.get("UploadFileSubDir")%>" />
											<input type="radio" id="pe_Vy" name="pe_arA" value="true" /><label for="pe_Vy"><span id="pe_Qq"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_Uu" name="pe_arA" value="false" /><label for="pe_Uu"><span id="pe_RM"></span></label>
										</td>
									</tr>
									...
									<tr>
										...
										<td >
											<table class="pe_hk">
                                                ...
                                                <tr>
                                                    <td >&nbsp;&nbsp;<span id="pe_JS"></span></td>
                                                    <td class="pe_eX"></td>
                                                    <td class="pe_fc"><input type="text" id="Height" name="Height" class="pe_uS" maxlength="10" value="<%=settingValue.get("Height")%>" /> px
													</td>
												</tr>
											</table>
										</td>
						...
						<tr>
							<td class="pe_pW pe_ne"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Ql"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_hk">
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_SW"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Qv"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Sg"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_VB"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Qk"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_RT"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Sl"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_QG"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_PZ"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										...
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<input type="text" id="DocBaseURL" name="DocBaseURL" class="pe_pm" value="<%=settingValue.get("DocBaseURL")%>" /> ex) http://www.mysite.com/doc.html 
										</td>
									</tr>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Wt"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Vn"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_abn"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_XP"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Vr"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<input type="number" min="0" max="60" style="ime-mode:disabled;" id="AutoSavePeriod" name="AutoSavePeriod" class="pe_pm" value="<%=settingValue.get("AutoSavePeriod")%>" /><b><span id="pe_PN"></span></b>&nbsp;&nbsp;<span id="pe_Uv"></span>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Sb"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Zz"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr id="pe_aWJ">
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_YB"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Yy"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr id="noUseLayerTracker">
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_buU"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
						...
						<tr>
							<td class="pe_pW pe_ne"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_TU"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_hk">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="AdminPageUploadFileExtBlockList"><span id="pe_Cq"></span></b></td>
										<td class="pe_eX"></td>
										<td>
											<table class="pe_hk">
												<input type="hidden" name="UploadImageFileExtBlockList" value="<%=settingValue.get("UploadImageFileExtBlockList")%>" />
												<tr>
													<td class="pe_fc"><input type="checkbox" id="UploadImageFileExtBlockListChecked" <%=settingValue.get("UploadImageFileExtBlockListChecked")%>/><span id="pe_wz"></span></td>
												</tr>
												<tr>
													<td class="pe_fc"><textarea id="UploadImageFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadImageFileExtBlockListTextarea")%></textarea><br /><span id="pe_La"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="AdminPageUploadFileExtBlockList"></span></b></td>
										<td class="pe_eX"></td>
										<td>
											<table class="pe_hk">
												<input type="hidden" name="UploadFileExtBlockList" value="<%=settingValue.get("UploadFileExtBlockList")%>" />
												<tr>
													<td class="pe_fc"><input type="checkbox" id="UploadFileExtBlockListChecked" <%=settingValue.get("UploadFileExtBlockListChecked")%>/><span id="pe_wz"></span></td>
												</tr>
												<tr>
													<td class="pe_fc"><textarea id="UploadFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadFileExtBlockListTextarea")%></textarea><br /><span id="pe_La"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_TV"></span></b></td>
										<td class="pe_eX"></td>
										<td >
											<table class="pe_hk">
												<input type="hidden" name="AttributeBlockList" value="<%=settingValue.get("AttributeBlockList")%>" />
												<tr>
													<td class="pe_fc"><input type="checkbox" id="AttributeBlockListChecked" <%=settingValue.get("AttributeBlockListChecked")%>/><span id="pe_wz"></span></td>
												</tr>
												<tr>
													<td class="pe_fc"><textarea id="AttributeBlockListTextarea" cols="70" rows="2"><%=settingValue.get("AttributeBlockListTextarea") %></textarea><br /><span id="pe_CS"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_SZ"></span></b></td>
										<td class="pe_eX"></td>
										<td >
											<table class="pe_hk">
												<input type="hidden" name="TagBlockList" value="<%=settingValue.get("TagBlockList")%>" />
												<tr>
													<td class="pe_fc"><input type="checkbox" id="TagBlockListChecked" <%=settingValue.get("TagBlockListChecked")%>/><span id="pe_wz"></span></td>
												</tr>
												<tr>
													<td class="pe_fc"><textarea id="TagBlockListTextarea" cols="70" rows="2"><%=settingValue.get("TagBlockListTextarea") %></textarea><br /><span id="pe_CS"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
						...
						<tr>
							<td class="pe_pW pe_ne"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Sm"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_hk" >
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_SE"></span></b></td>
										<td class="pe_eX"></td>
										<td>
											<table class="pe_hk">
												<input type="hidden" name="Template" id="Template" value="<%=settingValue.get("Template")%>" />
												<tr>
													<td class="pe_fc"><input type="button" id="pe_bhu" value="+" onClick="pe_am(this)"/></td>
													<td class="pe_fc">&nbsp;</td>
													<td class="pe_fc">&nbsp;</td>
												</tr>
												<tr style="background-color:#B2EBF4;">
													<td class="pe_fc"><b>Title</b></td>
													<td class="pe_fc"><b>URL</b></td>
													<td class="pe_fc"><b>Encoding</b></td>
												</tr>
											...
											for(int i=0; i<TemplateListArr.length ; i++){
												...
												if(TemplateListArr[i] == null || TemplateListArr[i] == ""){
													...
													%>
														<tr>
															<td><input type="text"  name="pe_ajr"  value="<%=templateName %>" style="width:100px"/></td>
															<td><input type="text"  name="pe_aAg"  value="<%=templateUrl %>" style="width:320px"/></td>
															<td><input type="text"  name="pe_ayr"  value="<%=templateEncoding %>" style="width:90px"/><input type="button" value="-" onclick="pe_e(this)"/></td>
					...
					<table class="pe_BM">
						<tr>
							<td>
								...
								<table class="pe_hk">
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Sd"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_ajT" class="color{hash:true,valueElement:'FontColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="FontColor" name="FontColor" value="<%=settingValue.get("FontColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_kR">
											<input type="button" class="pe_jO pe_iR" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_ajT').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_RL"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Qr"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
										<textarea name="Font" id="Font" cols="70" rows="2"><%=settingValue.get("Font") %></textarea><br /><span id="pe_abq"></span><br /><span id="pe_aan"></span></td>
									</tr>
									<tr>
										<td class="pe_dU" colspan="3"></td>
									</tr>
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Rj"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Qe"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										...
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_TY"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc"><input type="checkbox" id="ReturnKeyActionBRChecked" <%=settingValue.get("ReturnKeyActionBRChecked")%>/><label for="ReturnKeyActionBR"><span id="pe_Vj"></span></label></td>
									</tr>
									<tr>
										<td class="pe_dU" colspan="3"></td>
									</tr>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Wq"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_XI"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_ZA"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
								...
								<table class="pe_hk">
									<tr>
										<td class="pe_pW pe_ne"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Cq"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_RF"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_ajZ" class="color{hash:true,valueElement:'ImgLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="ImgLineColor" name="ImgLineColor" value="<%=settingValue.get("ImgLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_kR">
											<input type="button" class="pe_jO pe_iR" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_ajZ').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
								...
								<table class="pe_hk">				
									<tr>
										<td class="pe_pW pe_ne"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Ua"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Sq"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_akW" class="color{hash:true,valueElement:'TableLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableLineColor" name="TableLineColor" value="<%=settingValue.get("TableLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_kR">
											<input type="button" class="pe_jO pe_iR" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_akW').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Tk"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_aln" class="color{hash:true,valueElement:'TableBGColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableBGColor" name="TableBGColor" value="<%=settingValue.get("TableBGColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_kR">
											<input type="button" class="pe_jO pe_iR" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_aln').color.fromString('#FFFFFF');">
											</li>
											</ul></td>
											</tr>
											</table>
			...
			<td class="pe_mZ">
				<div id="pe_avO">
					<table class="pe_BM">
						<tr>
							<td>
								...
								<table class="pe_hk">
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_TZ"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Yp"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_MD"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<input type="text" id="Css" name="Css" class="pe_pm" value="<%=settingValue.get("Css")%>" />  ex) http://www.mysite.com/common.css 
										</td>
									</tr>
									<tr>
										<td class="pe_dU" colspan="3"></td>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Rk"></span></b>
										...
										<td >
											<table class="pe_hk">
												<tr>
													<td class="pe_BR">&nbsp;&nbsp;<span id="pe_VI"></span></td>
													<td class="pe_eX"></td>
													<td class="pe_fc">
														<input type="text" id="outlinecolor" name="outlinecolor" class="pe_Ah" value="" />  ex) #000000 or black 
													</td>
												</tr>
												<tr>
													<td class="pe_dU" colspan="3"></td>
												...
												<tr>
													<td class="pe_BR">&nbsp;&nbsp;<span id="pe_Rx"></span></td>
													<td class="pe_eX"></td>
													<td class="pe_fc">
														<input type="text" id="innerlineColor" name="innerlineColor" class="pe_Ah" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_dU" colspan="3"></td>
												...
												<tr>
													<td class="pe_BR">&nbsp;&nbsp;<span id="pe_Rc"></span></td>
													<td class="pe_eX"></td>
													<td class="pe_fc">
														<input type="text" id="skinfontColor" name="skinfontColor" class="pe_Ah" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_dU" colspan="3"></td>
												...
												<tr>
													<td class="pe_BR">&nbsp;&nbsp;<span id="pe_TJ"></span></td>
													<td class="pe_eX"></td>
													<td class="pe_fc">
														<input type="text" id="toolbarBackgroundColor" name="toolbarBackgroundColor" class="pe_Ah" value="" />
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Pu"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<input type="hidden" id="CreateTab" name ="CreateTab" value="<%=settingValue.get("CreateTab")%>" />
											<input type="checkbox" id="pe_Ly" name="pe_EH" value="0" /><label for="pe_Ly"><span id="wysiwyg"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_Nt" name="pe_EH" value="1" /><label for="pe_Nt"><span id="html"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_Ld" name="pe_EH" value="2" /><label for="pe_Ld"><span id="preview"></span></label>
										</td>
									</tr>
								</table>
						...
						<tr>
							<td class="pe_pW pe_ne"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_UL"></span></font></td>
						</tr>
						<tr>
							<td>
								<table class="pe_hk"><tr><td class="pe_kU" colspan="3"></td></tr>
								...
								<table class="pe_hk">
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_OF"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
						...
						<table class="pe_rs">
							<tr>
								<td>
									<table class="pe_hk">
										<tr>
											<td class="pe_dU" colspan="5"></td>
										</tr>
										<tr>
											<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Rd"></span></b></td>
											<td class="pe_eX"></td>
											<td>
												<table class="pe_hk">
													<tr>
														<td class="pe_CD" >&nbsp;&nbsp;<span id="pe_Rp"></span></td>
														<td class="pe_eX"></td>
														<td class="pe_fc">
															<input type="text" id="AdminPageUserMenuIdInput" name="AdminPageUserMenuIdInput" class="pe_pm" value="" /> 
														</td>
													</tr>
													<tr>
														<td class="pe_dU" colspan="3"></td>
													...
													<tr>
														<td class="pe_CD">&nbsp;&nbsp;<span id="pe_QY"></span></td>
														<td class="pe_eX"></td>
														<td class="pe_fc">
															<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_WE" value="function" /><label for="pe_WE"><span id="pe_Sk"></span></label>&nbsp;&nbsp;<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_XX" value="plugin" /><label for="pe_XX"><span id="pe_Sa"></span></label>
														</td>
													</tr>
													<tr>
														<td class="pe_dU" colspan="3"></td>
													...
													<tr>
														<td class="pe_CD">&nbsp;&nbsp;<span id="pe_Rq"></span></td>
														<td class="pe_eX"></td>
														<td class="pe_fc" height="50px">
															<input type="text" id="AdminPageUserMenuButtonImgPathInput" name="AdminPageUserMenuButtonImgPathInput" class="pe_pm" value="" />
													...
													<tr>
														<td class="pe_CD">&nbsp;&nbsp;<span id="pe_RR"></span></td>
														<td class="pe_eX"></td>
														<td class="pe_fc">	
															<input type="text" id="AdminPageUserMenuTitleInput" name="AdminPageUserMenuTitleInput" class="pe_pm" value="" />
														</td>
													</tr>
												</table>
											</td>
											<td class="pe_eX"></td>
											<td style="text-align:center;vertical-align:middle;"><input type="button" id="pe_Jg" value="" class="" style="width:60px;height:60px;"/>
											</td>
										</tr>
										<tr>
											<td class="pe_dU" colspan="5"></td>
										...
										<tr>
											<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_QI"></span></b></td>
											<td class="pe_eX"></td>
											<td class="pe_fc" colspan="2">
												<div id="pe_aVA">&nbsp;</div>
											</td>
										</tr>
										<tr>
					...
					<div id = "pe_hk">
						...
						<table class="pe_rs">	
							<tr>
								<td id="pe_abW" class="pe_ne">
									
									<table>
										<tr>
											<td id="pe_aWV">
												<span id="pe_OW"></span>: <br>
												<div id="pe_aBP" >
													<span id="pe_Ep"></span> <br> 
													<span id="pe_MW"></span><br>
													<span id="pe_Hn"></span><br>
												</div>
											</td>
											<td id="pe_aVB">
											<span id="pe_VF"></span>:<br>
												<div id="pe_anm" ></div>
											</td> 
											<td valign="bottom">
												<ul style="margin:0 auto;width:340px;">
													<li class="pe_kR">
														<input type="button" id="spacebar" value="" class="pe_jO pe_iR" style="width:80px;height:26px;" />
													</li>
													<li class="pe_kR"><input type="button" id="space" value="" class="pe_jO pe_iR" style="width:68px;height:26px;"></li>
													<li class="pe_kR"><input type="button" id="enter" value="" class="pe_jO pe_iR" style="width:66px;height:26px;"></li>
												</ul>
											</td>
										</tr>
										<tr>
					...
					<table class="pe_BM">
						<tr>
							<td>
								...
								<table class="pe_hk">
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Qc"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<input type="text" id="DocTitle" name="DocTitle" class="pe_pm" value="<%=settingValue.get("DocTitle")%>" />
										</td>
									</tr>
									<tr>
										<td class="pe_dU" colspan="3"></td>
									...
									<tr>
										<td class="pe_fF">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_RA"></span></b></td>
										<td class="pe_eX"></td>
										<td class="pe_fc">
											<input type="hidden" id="AccessibilityOption" name ="AccessibilityOption" value="<%=settingValue.get("AccessibilityOption")%>" />
											<input type="radio" id="pe_Zf" name="pe_LP" value="0" /><label for="pe_Zf"><span id="pe_Sf"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_Yd" name="pe_LP" value="1" /><label for="pe_Yd"><span id="pe_Rg"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_Yt" name="pe_LP" value="2" /><label for="pe_Yt"><span id="pe_Si"></span></label>
										</td>
									</tr>
									<tr>
										<td class="pe_dU" colspan="3"></td>
...
<input type="hidden" id="KakaoSpellChecker" name="KakaoSpellChecker" value="<%=settingValue.get("KakaoSpellChecker")%>" />
<input type="hidden" id="NamoAI" name="NamoAI" value="<%=settingValue.get("NamoAI")%>" />
