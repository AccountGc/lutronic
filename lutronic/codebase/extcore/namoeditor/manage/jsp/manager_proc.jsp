...
<%
	...
	if(check){
		result_sc = "<script type='text/javascript' language='javascript'>alert(NamoSELang.pe_Fk);window.document.location.href='manager_setting.jsp?Tab=" + detectXSSEx(request.getParameter("Tab")) + "';</script>";
	}
	else{
		result_sc = "<script>alert(NamoSELang.pe_zt+'" + fileName + "');history.back();</script> ";
	}
