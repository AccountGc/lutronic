...
//		sUploadURL = 'file_uploader_html5.jsp';
		sUploadURL = getCallUrl("/doc/smarteditorMultiImageUpload");
    ...
    function makeArrayFromString(sResString){
    	var	aTemp = [],
 		...
 		try{
 	    	console.log("sdkfpowjeporifjsoeij");
	...
	function onAjaxError (e){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/doc/imageUpload',	//샘플 URL입니다.
 	        sCallback : '/smarteditor2/sample/photo_uploader/callback',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
