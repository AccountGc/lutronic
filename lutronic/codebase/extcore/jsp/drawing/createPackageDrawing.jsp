...
$(function() {
	...
	$("#uploadPackageDrawing").click(function() {
		if($("#excelFile").val() == "") {
		...
		if(confirm("${f:getMessage('등록하시겠습니까?')}")){
			...
			$("#createPackageDrawing").attr("target", "list");
			$("#createPackageDrawing").attr("action", getURLString("drawing", "createPackageDrawingAction", "do")).submit();
		}
	})
	
	$("#download").click(function() {
		location="/Windchill/jsp/drawing/createDrawingPackage.xlsx";
	})
})
...
<form name="createPackageDrawing" id="createPackageDrawing" method="post" enctype="multipart/form-data">
            ...
            <col width='15%'><col width='35%'><col width='15%'><col width='35%'>
                ...
                <tr bgcolor="ffffff" style="height: 50px">
	                ...
	                <td class="tdwhiteL" >
		                ...
		                <button type="button" class="btnCRUD" id="uploadPackageDrawing">
		                	<span></span>
		                	${f:getMessage('등록')}
		                </button>
	                </td>
	            ...
	            <tr bgcolor="ffffff">
					...
					<td class="tdwhiteL" colspan="3">
						<jsp:include page="/eSolution/content/includeAttachFiles.do" flush="true">
							<jsp:param name="formId" value="createPackageDrawing"/>
							<jsp:param name="command" value="insert"/>
							<jsp:param name="btnId" value="uploadPackageDrawing" />
						</jsp:include>
					</td>
				</tr>
