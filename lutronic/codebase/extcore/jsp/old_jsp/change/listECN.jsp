...
function  lfn_Search(){
	...
	var url	= getURLString("changeECN", "listECNAction", "do");
	$.ajax({
		type:"POST",
		url: url,
		data:form,
...
function lfn_DhtmlxGridInit() {
	var COLNAMEARR = {
			...
			,col02 : 'ECN${f:getMessage("번호")}'
			,col03 : 'ECN${f:getMessage("제목")}'
			,col04 : '${f:getMessage("상태")}'
			,col05 : '${f:getMessage("등록자")}'
...
function onExcelDown() {
	...
	$("#changeRequestForm").attr("action", getURLString("excelDown", "ECNExcelDown", "do")).submit();
}
...
<input type="hidden" name="lifecycle" id="lifecycle" value="LC_ECN">
					...
					<table cellspacing="0" cellpadding="0" border=0 width=100% height=29 class="Subinfo_img_bg">
						<tr>
							...
							<td>
								...
								&nbsp; ECN ${f:getMessage("관리")} > ECN ${f:getMessage("검색")}
							</td>
						</tr>
					</table>
				</td>
		...
		<tr  align=center>
			<td valign="top" style="padding:0px 0px 0px 0px">
				...
				<col width='10%'><col width='40%'><col width='10%'><col width='40%'>
					<tr>
						<td class="tdblueM">ECN ${f:getMessage("제목")}</td>
						<td class="tdwhiteL">
							<input name="name" class="txt_field" size="30" style="width:90%" value=""/>
						</td>
						<td class="tdblueM">ECN ${f:getMessage("번호")}</td>
						<td class="tdwhiteL">
