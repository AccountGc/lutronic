...
function  lfn_Search(){
	...
	var url	= getURLString("changeECR", "listECRAction", "do");
	$.ajax({
		type:"POST",
		url: url,
		data:form,
...
function onExcelDown() {
	...
	$("#changeRequestForm").attr("action", getURLString("excelDown", "ECRExcelDown", "do")).submit();
}
</script>
<body>
				...
				<table cellspacing="0" cellpadding="0" border=0 width=100% height=29 class="Subinfo_img_bg">
					<tr>
						...
						<td>
							...
							&nbsp; CR/ECPR ${f:getMessage("관리")} > CR/ECPR ${f:getMessage("검색")}
						</td>
					</tr>
				</table>
			</td>
