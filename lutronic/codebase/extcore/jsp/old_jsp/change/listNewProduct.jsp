...
function lfn_DhtmlxGridInit() {
	var COLNAMEARR = {
			...
			,col02 : 'IPO${f:getMessage('번호')}'
			,col03 : 'IPO${f:getMessage('제목')}'
...
function onExcelDown() {
	...
	$("#changeRequestForm").attr("action", getURLString("excelDown", "IPOExcelDown", "do")).submit();
}
...
<input type="hidden" name="eoType" id="eoType" value="IPO">
					...
					<table cellspacing="0" cellpadding="0" border=0 width=100% height=29 class="Subinfo_img_bg">
						<tr>
							...
							<td>
								...
								&nbsp; ${f:getMessage('신제품')} ${f:getMessage('관리')} > ${f:getMessage('신제품')} ${f:getMessage('검색')}
							</td>
						</tr>
					</table>
				</td>
		...
		<tr  align=center>
			<td valign="top" style="padding:0px 0px 0px 0px">
				...
				<col width='10%'><col width='40%'><col width='10%'><col width='40%'>
					<tr>
						<td class="tdblueM">IPO ${f:getMessage('제목')}</td>
						<td class="tdwhiteL">
							<input name="name" class="txt_field" size="30" style="width:90%" value=""/>
						</td>
						<td class="tdblueM">IPO ${f:getMessage('번호')}</td>
						<td class="tdwhiteL">
