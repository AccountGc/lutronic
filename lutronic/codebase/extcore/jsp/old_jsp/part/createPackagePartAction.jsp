...
function lfn_DhtmlxGridInit(){
	var COLNAMEARR = {
			 col01 : 'NO'
			,col02 : '${f:getMessage('품목번호')}'
			,col03 : '${f:getMessage('품목명')}'
			,col04 : '${f:getMessage('단위')}'
			,col05 : '${f:getMessage('프로젝트코드')}'
			,col06 : '${f:getMessage('프로젝트명')}'
			,col07 : '${f:getMessage('부서 코드')}'
			,col08 : '${f:getMessage('부서 명')}'
			,col09 : '${f:getMessage('제작방법 코드')}'
			,col10 : '${f:getMessage('제작방법 명')}'
			,col11 : '${f:getMessage('재질 코드')}'
			,col12 : '${f:getMessage('재질 명')}'
			,col13 : '${f:getMessage('사양')}'
			,col14 : '${f:getMessage('도면파일')}'
			,col15 : '${f:getMessage('체크 여부')}'
			,col16 : '${f:getMessage('에러 내용')}'
	}
