...
$(function() {
	...
	*                      Excel Down 버튼
	----------------------------------------------------------%>
	$("#compareExcel").click(function() {
		/*
		$("#BomCompareForm").attr("method", "post");
		$("#BomCompareForm").attr("action", getURLString("excelDown", "compareBomExcelDown", "do")).submit();
		*/
		var form = $("form[name=BomCompareForm]").serialize();
		var url = getURLString("excelDown", "compareBomExcelDown", "do");
...
function lfn_DhtmlxGridInit(){
	...
	BaseLineGrid.setHeader("${title1 },#cspan,#cspan,#cspan,#cspan,#cspan,${title2},#cspan,#cspan,#cspan,#cspan,#cspan",null,sHeaderAlign);
	//BaseLineGrid.attachHeader(["부품번호","부품명","Rev.","단위","수량","품목번호","기준 수량","&nbsp;","부품번호","부품명","버전","단위","수량"]);
	BaseLineGrid.attachHeader(["Level","부품번호","부품명","Rev.","단위","수량","&nbsp;","Level","부품번호","부품명","Rev.","수량"]);
				    ...
				    <td align=right>
		                <table border="0" cellpadding="0" cellspacing="4" align="right">
		                    <tr>
		                    	...
		                    	<td> 
		                        	<button type="button" class="btnCustom" id="compareExcel">
		                        		<span></span>
		                        		Excel Down
		                        	</button>
		                        </td>
