	...
	$("#createBtn").click(function() {
		...
		*/
		if(confirm("${f:getMessage('등록하시겠습니까?')}")){
			//common_submit("admin", "createRootDefinitionAction", "createRootDefinition", "admin_listChangeActivity").submit();
			var form = $("form[name=createRootDefinition]").serialize();
			var url	= getURLString("admin", "createRootDefinitionAction", "do");
			$.ajax({
				type:"POST",
				url: url,
				data:form,
...
<form name=createRootDefinition>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="3">
				<tr>
					<td>
						...
						&nbsp;${f:getMessage('설계변경')}&nbsp;${f:getMessage('활동')}&nbsp; ROOT &nbsp;${f:getMessage('등록')}
					</td>
					<td>
					...
					<td valign="top" style="padding:0px 0px 0px 0px" colspan="2">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
							...
							<tr bgcolor="ffffff" height="35">
								...
								<td class="tdwhiteL" >
									<textarea name="description" id="description" rows="5" class="fm_area" style="width:98%" onchange="textAreaLengthCheckName('eoCommentA', '4000', '${f:getMessage('설명')}')"></textarea>
								</td>
							</tr>
						</table>
						<!-- Create Table End -->
