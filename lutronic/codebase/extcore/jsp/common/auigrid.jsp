...
<!-- AUIGrid css -->
<link rel="stylesheet" href="/Windchill/extcore/component/AUIGrid/AUIGrid_classic_style.css?v=1543">

<!-- AUIGrid js -->
<script src="/Windchill/extcore/component/AUIGrid/AUIGrid.js?v=2"></script>
<script src="/Windchill/extcore/component/AUIGrid/AUIGridLicense.js?v=2"></script>
