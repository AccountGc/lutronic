...
function gotoPage(){
	...
	//$("#redirectForm").attr("action","<c:out value='${page}' escapeXml='false'/>").submit();
	parent.document.location = "<c:out value='${page}' escapeXml='false'/>";
}
</script>
</head>
<body onload="gotoPage()">
<form name="redirectForm" id="redirectForm" method="post" action="<c:out value="${page}" escapeXml="false"/>">
</form>
</body>
</html>
