...
<%
ArrayList<NumberCode> documentTemplateTypeList = (ArrayList<NumberCode>) request
		.getAttribute("documentTemplateTypeList");
%>
<!DOCTYPE html>
<html>
<head>
	...
	<form>
		...
		<table class="create-table">
			...
			<tr>
				...
				<td class="indent5">
					<input type="text" name="number" id="number" class="width-400">
				</td>
			</tr>
			<tr>
				<th class="req lb">문서양식 제목</th>
				<td class="indent5">
			...
			<tr>
				...
				<td class="indent5">
					<select name="templateType" id="templateType" class="width-300">
						<option value="">선택</option>
						<%
						for (NumberCode nc : documentTemplateTypeList) {
							String oid = nc.getPersistInfo().getObjectIdentifier().getStringValue();
							String display = nc.getName();
						%>
						<option value="<%=oid%>"><%=display%></option>
						<%
						}
						%>
					</select>
