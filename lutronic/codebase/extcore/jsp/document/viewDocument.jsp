				...
				<tr>
					...
					<td>
						...
						<table border="0" cellpadding="0" cellspacing="4" align="right">
			                <tr>
			                	<c:if test="${docData.isLatest() }">
			                		<c:if test='${docData.isState("APPROVED") }'>
										<td>
									...
									<c:if test='${docData.isState("INWORK") || docData.isState("BATCHAPPROVAL") || docData.isState("REWORK") }'>
										<td>
								...
								<c:if test="${!docData.isLatest() }">
									...
									<td>
										<button type="button" name="latestBtn" id="lastestBtn" class="btnCustom" value="<c:out value='${docData.latestOid() }'/>">
											<span></span>
											${f:getMessage('최신Rev.')}
										</button>
									</td>
							...
							<tr bgcolor="ffffff" height="35">
			                    ...
			                    <td class="tdwhiteL" colspan="3" style="word-break:break-all;" >
			                    	<div class="textarea_autoSize">
										<textarea name="description" id="description"  readonly><c:out value="${docData.getDescription(false) }" escapeXml="false" /></textarea>
									</div>
								</td>
							</tr>
...
<!-- 관련 ECO -->
<jsp:include page="/eSolution/changeECO/include_ECOView_ECA.do">
	<jsp:param value="doc" name="moduleType"/>
	<jsp:param value="${docData.oid }" name="oid"/>
	<jsp:param value="${f:getMessage('관련 ECO')}" name="title"/>
</jsp:include>
