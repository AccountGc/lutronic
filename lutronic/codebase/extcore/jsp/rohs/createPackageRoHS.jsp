...
$(function() {
	...
	$("#uploadPackageRoHS").click(function() {
		...
		if(confirm("${f:getMessage('등록하시겠습니까?')}")){
			...
			$("#createPackageRoHS").attr("target", "list");
			$("#createPackageRoHS").attr("action", getURLString("rohs", "createPackageRoHSAction", "do")).submit();
		}
	})
	$("#download").click(function() {
		location = "/Windchill/jsp/rohs/CreateRoHSPackage.xlsx";
	})
})
...
<form name="createPackageRoHS" id="createPackageRoHS" method="post" enctype="multipart/form-data">
	            ...
	            <tr bgcolor="ffffff">
					...
					<td class="tdwhiteL" colspan="3">
						<jsp:include page="/eSolution/content/includeAttachFiles.do" flush="true">
							<jsp:param name="formId" value="createPackageRoHS"/>
							<jsp:param name="command" value="insert"/>
							<jsp:param name="btnId" value="" />
						</jsp:include>
					</td>
				</tr>
