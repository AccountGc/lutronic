...
<form name="rohsViewForm" id="rohsViewForm" method="post" >
					...
					<td>
						...
						<table border="0" cellpadding="0" cellspacing="4" align="right">
			                <tr>
								...
								<c:if test="${rohsData.isLatest() }">
									<td>
										<button type="button" name="copyRohs" id="copyRohs" class="btnCRUD" !style='display: none;'>
											<span></span>
											${f:getMessage('물질복사')}
										</button>
									</td>
								
			                		<c:if test='${rohsData.isState("APPROVED") }'>
										<td>
									...
									<c:if test='${rohsData.isState("INWORK") || rohsData.isState("BATCHAPPROVAL") || rohsData.isState("REWORK") }'>
										<td>
								...
								<c:if test="${!rohsData.isLatest() }">
									...
									<td>
										<button type="button" name="latestBtn" id="lastestBtn" class="btnCustom" value="<c:out value='${rohsData.latestOid() }'/>">
											<span></span>
											${f:getMessage('최신Rev.')}
										</button>
									</td>
		                		...
		                		<!--  
		                		<td>
		                			<button type="button" name="drawingDown" id="drawingDown" class="btnCustom">
												<span></span>
												${f:getMessage('일괄다운')}
											</button>
		                		</td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
							...
							<tr bgcolor="ffffff" height="35">
			                    ...
			                    <div class="textarea_autoSize">
			                    	<textarea name="description" id="description"  readonly><c:out value="${rohsData.getDescription(false) }" escapeXml="false" /></textarea>
								</div>
								</td>
							</tr>
							
							<tr bgcolor="ffffff" height="35">
								<td class="tdblueM">${f:getMessage('첨부파일')}<br>
