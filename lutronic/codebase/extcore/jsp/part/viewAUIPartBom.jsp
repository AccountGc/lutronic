...
function viewAUIPartBomAction(){
	isExpanded = false;
	var form = $("form[name=PartTreeForm]").serialize();
	var url	= getURLString("part", "viewAUIPartBomAction", "do");
	$.ajax({
		type:"POST",
		url: url,
		data : form,
		...
		success:function(data){
			...
			//alert(gridData);
			// 그리드에 데이터 세팅
			//AUIGrid.clearGridData(gridData);
			//AUIGrid.destroy(myBOMGridID);
		    	...
		    	<tr height="30">
		    		<td width="40%" align="left">
		    			<table border="0" cellpadding="0" cellspacing="4" align="left">
		    				<tr>
								<td valign="bottom">
					    			<button type="button" name="expand" id="expand" class="btnCustom" style="width: 70px">
					    			<span></span>펼치기</button>
