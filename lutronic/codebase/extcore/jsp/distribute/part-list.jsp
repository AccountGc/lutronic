		...
		<table class="button-table">
			<tr>
				<td class="left">
					...
					<img src="/Windchill/extcore/images/save.gif" title="테이블 저장" onclick="saveColumnLayout('listPart');">
					<img src="/Windchill/extcore/images/redo.gif" title="테이블 초기화" onclick="resetColumnLayout('listPart');">
		...
		<script type="text/javascript">
				...
				return [ {
					...
					renderer : {
						...
						jsCallback : function(rowIndex, columnIndex, value, item) {
							...
							const url = getCallUrl("/distribute/productView?oid=" + oid);
			...
			function loadGridData() {
				...
				const field = [ "location", "partNumber", "partName", "createdFrom", "createdTo", "modifiedFrom", "modifiedTo", "creator", "model", "productmethod", "deptcode", "unit", "weight", "mat", "finish", "remarks",
					"ecoNo", "eoNo","creatorOid","latest" ,"specification", "state"];
			...
			document.addEventListener("DOMContentLoaded", function() {
				toFocus("partNumber");
				const columns = loadColumnLayout("listPart");
