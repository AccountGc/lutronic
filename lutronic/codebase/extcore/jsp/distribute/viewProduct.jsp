            ...
            <table width="100%" border="0" cellpadding="1" cellspacing="0" class="tablehead" align="center" style="padding-bottom:10px">
		   		<tr> 
		   			<td height="30" width="93%" align="center">
		   				<B><font color=white>${f:getMessage('완제품')} ${f:getMessage('상세보기')}</font></B>
		   			</td>
		   		</tr>
			</table>
...
<!-- 관련 ECO -->
<jsp:include page="/eSolution/distribute/include_DistributeECOList.do">
	<jsp:param name="moduleType" value="CHANGE"/>
...
<!-- 관련 EO -->
<jsp:include page="/eSolution/distribute/include_DistributeECOList.do">
	<jsp:param name="moduleType" value="PRODUCT"/>
	<jsp:param name="title" value="${f:getMessage('관련')} EO"/>
	<jsp:param name="oid" value="${partData.oid }"/>
</jsp:include>
