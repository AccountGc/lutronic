	...
	<form>
		...
		<table class="search-table">
			...
			<tr>
				...
				<th>설계변경 CUD</th>
				<td class="indent5"><input type="text" name="zitmsta" id="zitmsta" class="width-200"></td>
			</tr>
			<tr>
				<th>모품번</th>
				<td class="indent5"><input type="text" name="matnr" id="matnr" class="width-200"></td>
				<th>자품번</th>
				<td class="indent5"><input type="text" name="idnrk" id="idnrk" class="width-200"></td>
			</tr>
			<tr>
				<th>변경 번호</th>
				<td class="indent5" colspan="3"><input type="text" name="aennr" id="aennr" class="width-200"></td>
			</tr>
			<tr>
				<th>인터페이스상태</th>
				<td>&nbsp;
		...
		<table class="button-table">
			<tr>
				<td class="left">
					...
					<img src="/Windchill/extcore/images/save.gif" title="테이블 저장" onclick="saveColumnLayout('send-listBOMERP');">
		...
		<script type="text/javascript">
			...
			document.addEventListener("DOMContentLoaded", function() {
				const columns = loadColumnLayout("send-listBOMERP");
