...
$(function() {
	$("#doBatchRevision").click(function() {
		...
		if(!confirm("${f:getMessage('일괄 개정을 하시겠습니까?')}")){
			return;
		}
		
		$("#batchRevision").attr("action", getURLString("changeECO", "batchRevisionAction", "do")).submit();
	})
})
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="3">
	<tr>
		<td ><img src='/Windchill/jsp/portal/images/base_design/Sub_Right_ico.gif' width='10' height='9' />&nbsp;<b>${f:getMessage('품목 일괄 개정')}</b></td>
		<td>
