...
//	public String viewDescription;
	...
	public DEFData(EChangeActivityDefinition def) {
		...
		setActivityName(ChangeUtil.getActivityName(this.activityType));
		setActiveUser(def.getActiveUser());
		if(activeUser != null){
			setActiveUserOid(CommonUtil.getOIDString(activeUser));
			setActiveUserName(activeUser.getFullName());
		}
