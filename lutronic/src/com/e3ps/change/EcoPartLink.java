 ...
 * <code>EcoPartLink</code> constructor, to construct instances of this class.
...
@GenAsBinaryLink(superClass = ObjectToObjectLink.class, serializable = Serialization.EXTERNALIZABLE_BASIC, properties = {
		...
		@GeneratedProperty(name = "grouping", type = String.class) }, roleA = @GeneratedRole(name = "part", type = WTPartMaster.class), roleB = @GeneratedRole(name = "eco", type = EChangeOrder.class), tableProperties = @TableProperties(tableName = "EcoPartLink"))
