...
@GenAsPersistable(superClass = ECOChange.class, interfaces = { WTContained.class, OwnPersistable.class,
		ContentHolder.class }, properties = { @GeneratedProperty(name = "licensingChange", type = String.class),
		...
		foreignKeys = {
				@GeneratedForeignKey(myRoleIsRoleA = false, foreignKeyRole = @ForeignKeyRole(name = "worker", type = wt.org.WTUser.class), myRole = @MyRole(name = "eco", cardinality = Cardinality.ZERO_TO_ONE)) })
