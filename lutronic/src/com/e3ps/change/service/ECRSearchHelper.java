...
public class ECRSearchHelper {
	public static final ECRSearchService service = ServiceFactory.getService(ECRSearchService.class);
	public static final ECRSearchHelper manager = new ECRSearchHelper();
	
	public Map<String, Object> listECRAction(HttpServletRequest req) throws Exception{
		Map<String, Object> map = new HashMap<>();
		ArrayList<ECRData> list = new ArrayList<>();
			QuerySpec query = getECRQuery(req);
			
			QueryResult result = PersistenceHelper.manager.find(query);
			while (result.hasMoreElements()) {
				Object[] obj = (Object[]) result.nextElement();
				EChangeRequest ecr = (EChangeRequest) obj[0];
