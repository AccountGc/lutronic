    ...
    public class MouseHandle extends MouseAdapter
    {
        public void mouseClicked(MouseEvent e)
        {
            if (e.getClickCount() == 2)
            {
               ...
               /*
                if(ApprovalHelper.MASTER_APPROVED.equals(edata.state) || ApprovalHelper.MASTER_APPROVING.equals(edata.state)){
                	return;
                }
                */
                ...
                Thread thread = new Thread() {
                    public void run()
                    {
                        try
                        {
                            ...
                            {
                                int i = JOptionPane.showOptionDialog(dialog, "등록된 내용이 사라집니다.", "경고", -1, 2, null,
