 ...
 *
 * <p>
 * Use the <code>newROHSContHolder</code> static factory method(s), not
 * the <code>ROHSContHolder</code> constructor, to construct instances of
...
@GenAsPersistable(
   ...
   @GeneratedForeignKey(name="RohsHolderLink", myRoleIsRoleA=false,
      foreignKeyRole=@ForeignKeyRole(name="rohs", type=com.e3ps.rohs.ROHSMaterial.class,
         constraints=@PropertyConstraints(required=true)),
      myRole=@MyRole(name="holder"))
   })
public class ROHSContHolder extends _ROHSContHolder {
    ...
    *
    * @return    ROHSContHolder
    * @exception wt.util.WTException
    **/
   public static ROHSContHolder newROHSContHolder()
            throws WTException {
