...
import com.e3ps.org.dto.DepartmentHelper;
...
public class GroupwareController extends BaseController {
	...
	public List<NoticeDTO> popupNoticeAction(HttpServletRequest request, HttpServletResponse response) {
...
//	}
	...
	public Map<String, Object> userInfoEdit(@RequestBody PeopleDTO data) throws Exception {
