...
public class IBAUtil {
    ...
    public static String getAttrValue_Part_Desc(IBAHolder ibaHolder, String attrName) throws RemoteException, WTException {
        String returnStr = "";
        if (ibaHolder == null) {
        	return returnStr;
		}
        ...
        select.appendOrderBy(new OrderBy(new ClassAttribute(StringValue.class, "thePersistInfo.modifyStamp"), true), new int[] { idx_StrVal });
    ...
    public static String getAttrfloatValue(IBAHolder ibaHolder, String attrName) throws RemoteException, WTException {
        ...
        SearchCondition where = new SearchCondition(new ClassAttribute(FloatValue.class, "theIBAHolderReference.key.id"), "=", new ClassAttribute(target, "thePersistInfo.theObjectIdentifier.id"));
        select.appendWhere(where, new int[] { idx_StrVal, idx });
        select.appendAnd();
        where = new SearchCondition(new ClassAttribute(FloatValue.class, "definitionReference.hierarchyID"), "=", new ClassAttribute(FloatDefinition.class, "hierarchyID"));
        select.appendWhere(where, new int[] { idx_StrVal, idx_StrDef });
        select.appendAnd();
    ...
    public static String getAttrIntegerValue(IBAHolder ibaHolder, String attrName) throws RemoteException, WTException {
        ...
        SearchCondition where = new SearchCondition(new ClassAttribute(IntegerValue.class, "theIBAHolderReference.key.id"), "=", new ClassAttribute(
                target, "thePersistInfo.theObjectIdentifier.id"));
        select.appendWhere(where, new int[] { idx_StrVal, idx });
        select.appendAnd();
        where = new SearchCondition(new ClassAttribute(IntegerValue.class, "definitionReference.hierarchyID"), "=", new ClassAttribute(
                StringDefinition.class, "hierarchyID"));
        select.appendWhere(where, new int[] { idx_StrVal, idx_StrDef });
        select.appendAnd();
        select.appendWhere(new SearchCondition(IntegerDefinition.class, "name", "=", attrName), new int[] { idx_StrDef });
