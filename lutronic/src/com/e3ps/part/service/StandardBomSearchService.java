...
public class StandardBomSearchService extends StandardManager implements BomSearchService {
	...
	*/
	 ...
	 */
	@Override
	public List<Map<String, Object>> getAUIPartTreeAction(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//System.out.println("baseline2 =" + baseline2);
