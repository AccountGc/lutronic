...
//   @RBEntry("ERP Job")
//   @RBComment("Plural name to display for ERP Job")
//   public static final String erpJob = "erpJob";
//
//   @RBEntry("ERP Jobs")
//   @RBComment("Plural name to display for ERP Jobs")
//   public static final String erpJobs = "erpJobs";
}
