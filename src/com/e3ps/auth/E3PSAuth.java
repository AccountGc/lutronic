 ...
 *
 * <p>
 * Use the <code>newE3PSAuth</code> static factory method(s), not the <code>E3PSAuth</code>
...
@GenAsPersistable(interfaces={Tree.class}, 
   ...
   @GeneratedProperty(name="codeA", type=String.class,
      constraints=@PropertyConstraints(upperLimit=20)),
   @GeneratedProperty(name="codeB", type=String.class,
      constraints=@PropertyConstraints(upperLimit=50)),
   @GeneratedProperty(name="codeC", type=String.class,
      constraints=@PropertyConstraints(upperLimit=20))
   })
public class E3PSAuth extends _E3PSAuth {
    ...
    **/
   public static E3PSAuth newE3PSAuth()
            throws WTException {

      E3PSAuth instance = new E3PSAuth();
      instance.initialize();
      return instance;
   }
