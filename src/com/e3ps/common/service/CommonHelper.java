...
public class CommonHelper {
	...
	public Map<String, String> getAttributes(String oid, String mode) throws Exception {
		...
		manufacture_code = StringUtil.checkNull(IBAUtil.getAttrValue(iba, AttributeKey.IBAKey.IBA_MANUFACTURE));
		...
		map.put("manufacture_code", manufacture_code);
