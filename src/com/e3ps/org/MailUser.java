 ...
 *
 * <p>
 * Use the <code>newMailUser</code> static factory method(s), not the <code>MailUser</code>
...
@GenAsPersistable(
   ...
   @GeneratedProperty(name="isDisable", type=boolean.class, initialValue="true",
      javaDoc="?? ?? ??")
   })
public class MailUser extends _MailUser {
    ...
    **/
   public static MailUser newMailUser()
            throws WTException {

      MailUser instance = new MailUser();
      instance.initialize();
      return instance;
   }
