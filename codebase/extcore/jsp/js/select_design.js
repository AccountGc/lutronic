...
function settingValue(thisId,thisString) {
	...
	if (selectedArea){
		var v = valueString.replace("&","&");
		v = v.replace("none","");
		selectedArea.innerHTML = v.substring(v.indexOf("<img src=/Windchill/jsp/org/images/tree/opened_folder.png border=0>"));
	}
}
