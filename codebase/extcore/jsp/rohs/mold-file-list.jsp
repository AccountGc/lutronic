	...
	<form name="listRoHSData" id="listRoHSData">
		...
		<table class="search-table">
			...
			<tr>
				...
				<td class="indent5" colspan="3">
					<input type="text" name="fileName" id="fileName" class="width-300">
				</td>
				<th>발행일자</th>
				<td class="indent5">
					<input type="text" name="publicationFrom" id="publicationFrom" class="width-100">
					~
		...
		<table class="button-table">
			<tr>
				<td class="left">
					...
					<img src="/Windchill/extcore/images/save.gif" title="테이블 저장" onclick="saveColumnLayout('file-list');">
					<img src="/Windchill/extcore/images/redo.gif" title="테이블 초기화" onclick="resetColumnLayout('file-list');">
				</td>
				<td class="right">
		...
		<script type="text/javascript">
			...
			function loadGridData(movePage) {
				...
				const url = getCallUrl("/rohs/file");
				const field = [ "sortKey", "sortType", "fileType", "publicationFrom", "publicationTo", "fileName" ];
			...
			document.addEventListener("DOMContentLoaded", function() {
				toFocus("fileName");
				const columns = loadColumnLayout("file-list");
