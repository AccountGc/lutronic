...
// 				loadGridData();
			...
			function loadGridData(movePage) {
				...
				const field = [ "sortType", "sortKey", "name", "number", "state", "creatorOid", "createdFrom", "createdTo", "approveFrom", "approveTo", "writer", "createDepart", "writedFrom", "writedTo", "changeSection", "modelcode" ];
