...
// 				loadGridData();
			...
			function loadGridData(movePage) {
				...
				const field = [ "sortType", "sortKey", "name", "number", "createdFrom", "createdTo", "creatorOid", "licensing", "modelcode", "sortCheck", "sortValue", "riskType", "approveFrom", "approveTo", "state"];
