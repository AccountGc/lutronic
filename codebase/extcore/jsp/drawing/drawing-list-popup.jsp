...
<table class="button-table">
	<tr>
		...
		<td class="right">
			...
			<input type="button" value="추가" title="추가" class="blue" onclick="insertRow();">
	...
	<tr>
		<td valign="top">
			<jsp:include page="/extcore/jsp/common/folder-include.jsp">
				...
				<jsp:param value="495" name="height" />
			</jsp:include>
		</td>
		<td valign="top">&nbsp;</td>
		<td valign="top">
...
<script type="text/javascript">
	...
	function insertRow() {
		...
		for (let i = 0; i < checkedItems.length; i++) {
			...
			const cadType = item.cadType;
			if (cadType !== "어셈블리") {
				// 				alert("기타 도면은 대상이 아닙니다.");
				return false;
			}
		}

		opener.insertRow(checkedItems, function(res, close, msg) {
			trigger(close, msg);
		})
	}
	...
	function loadGridData(movePage) {
		...
		const field = [ "sortKey", "sortType", "location", "cadDivision", "cadType", "number", "name", "createdFrom", "createdTo", "modifiedFrom", "modifiedTo", "creatorOid", "state", "modelcode", "productmethod", "deptcode", "unit", "weight1", "weight2", "manufacture", "mat", "finish", "remarks",
				"specification" ];
