...
G_dextResizeBackDiv:null,G_isResize:!1,G_isDrag:!1,G_firstDrag:!1,G_checkTagName:",img,iframe,td,th,table,embed,div,video,",G_deleteCheckTagName:",table,video,",G_mouseOveriframeObj:null,G_dextIframeOverDiv:null,G_startX:0,G_startY:0,G_dragX:0,G_dragY:0,G_lastDragX:0,G_lastDragY:0,G_orgEnterTag:"",G_ie8Bug:!1,keyDownEvt:null,G_dextResize_elem_Rect:null,G_UseMouseTableInoutdent:!1,G_ImageR:1,G_ResizeHandlerActivatedFlag:!1,G_setUndo:!1},a;for(a in b)this[a]=b[a]}
DextDragResize.prototype.selection=function(b){try{if(b){DEXTTOP.G_CURREDITOR.dext_dragresize.preventScrollMove();var a=getFirstRange(),c=a.range;a.sel.removeAllRanges();c.selectNode(b);a.sel.addRange(c);(DEXTTOP.DEXT5.browser.chrome||DEXTTOP.DEXT5.browser.opera)&&b.tagName&&"TABLE"==b.tagName&&(DEXTTOP.G_COPIEDTABLE=b,command_tableCopy(DEXTTOP.G_CURREDITOR.ID,DEXTTOP.G_CURREDITOR,!0))}}catch(d){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(d)}};
DextDragResize.prototype.apply=function(b){try{var a=this;a.mouseDownEvt=function(b){try{a.mouseDown(b)}catch(c){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(c)}};a.mouseMoveTopEvt=function(b){try{a.elementResize(b,"top")}catch(c){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(c)}};a.mouseUpEvt=function(b){try{a.mouseUp(b)}catch(c){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(c)}};a.mouseOverEvt=function(b){try{a.mouseOver(b)}catch(c){DEXTTOP&&DEXTTOP.DEXT5&&
DEXTTOP.DEXT5.logMode&&console.log(c)}};a.keyDownEvt=function(b){try{a.keyDown(b)}catch(c){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(c)}};a.dragEndEvt=function(b){try{a.dragEnd(b)}catch(c){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(c)}};DEXTTOP.DEXT5.util.addEvent(b,"mouseover",a.mouseOverEvt,!0);DEXTTOP.DEXT5.util.addEvent(b,"mousedown",a.mouseDownEvt,!0);DEXTTOP.DEXT5.util.addEvent(DEXTTOP.DEXTDOC,"mousemove",a.mouseMoveTopEvt,!0);DEXTTOP.DEXT5.util.addEvent(DEXTTOP.DEXTDOC,
"mouseup",a.mouseUpEvt,!0);DEXTTOP.DEXT5.util.addEvent(document,"mouseup",a.mouseUpEvt,!0);DEXTTOP.DEXT5.util.addEvent(b,"mouseup",a.mouseUpEvt,!0);DEXTTOP.DEXT5.util.addEvent(b,"dragstart",function(){(0==DEXTTOP.DEXT5.browser.ie||DEXTTOP.DEXT5.browser.ie&&8>=DEXTTOP.DEXT5.browser.ieVersion)&&a.resizeHandleClear();a.removePreventScrollMove()});DEXTTOP.DEXT5.util.addEvent(b,"dragend",a.dragEndEvt,!0)}catch(c){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(c)}};
...
"dragend",this.dragEndEvt,!0)}catch(a){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(a)}};DextDragResize.prototype.dragEnd=function(b){with(this)"1"!=DEXTTOP.G_CURREDITOR._config.dragResizeMovable&&G_dextResize_elem&&"absolute"!=G_dextResize_elem.style.position.toLowerCase()&&(selection(G_dextResize_elem),resizeHandleClear(),this.removePreventScrollMove())};
...
G_dextResize_elem.style.position.toLowerCase()||"div"==c.tagName.toLowerCase()?DEXTTOP.DEXT5.util.cancelEvent(b):selection(c)}else G_dextResizeIcon!=c&&c!=G_dextResizeDiv&&(GetParentbyTagName(c,"div"),resizeHandleClear())}catch(e){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(e)}}};
...
"th"==e?GetParentbyTagName(d,"table"):d;if("table"==g.tagName.toLowerCase()&&checkNoResizeTable(g))return;"IMG"==g.tagName&&"FIGURE"==g.parentNode.tagName&&(g=g.parentNode);if(G_dextResize_elem==g||G_dextResize_OverElem==g)return;G_dextResize_OverElem=g;if("div"==G_dextResize_OverElem.tagName.toLowerCase()&&"div"==_iframeDoc.activeElement.tagName.toLowerCase())return;DEXTTOP.G_CURREDITOR=a;G_ResizeHandlerActivatedFlag||setResizeIcon();DEXTTOP.DEXT5.util.addEvent(G_dextResize_OverElem,"mouseout",ResizeElmOutEvt)}else{var k=
GetParentbyTagName(d,"table"),h=GetParentbyTagName(d,"div");if(k||h){k&&h?G_dextResize_OverElem=GetParentbyTagName(h,"table")?h:k:k?G_dextResize_OverElem=k:h&&(G_dextResize_OverElem=h);if("div"==G_dextResize_OverElem.tagName.toLowerCase()&&"div"==_iframeDoc.activeElement.tagName.toLowerCase())return;if("table"==G_dextResize_OverElem.tagName.toLowerCase()&&checkNoResizeTable(G_dextResize_OverElem)){G_dextResize_OverElem=null;return}if("div"==G_dextResize_OverElem.tagName.toLowerCase()&&(-1<G_dextResize_OverElem.className.indexOf("DEXT_fiVe_Page_Break")||
""!=a._config.dragResizeApplyDivClass&&(f=","+a._config.dragResizeApplyDivClass+",",0>f.indexOf(","+G_dextResize_OverElem.className+","))))return;DEXTTOP.G_CURREDITOR=a;G_ResizeHandlerActivatedFlag||setResizeIcon();DEXTTOP.DEXT5.util.addEvent(G_dextResize_OverElem,"mouseout",ResizeElmOutEvt)}}}catch(m){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(m)}}};
...
DEXTTOP.DEXT5.util.addEvent(G_dextResizeIcon,"mouseover",function(){G_REMOVE_dextResizeIcon=!1}),DEXTTOP.DEXT5.util.addEvent(G_dextResizeIcon,"mouseout",function(){G_REMOVE_dextResizeIcon=!0}),DEXTTOP.DEXT5.util.addEvent(G_dextResizeIcon,"mousedown",function(a){DEXTTOP.G_CURREDITOR._LastRange=saveSelection(DEXTTOP.G_CURREDITOR.ID,!0)}),DEXTTOP.DEXT5.util.addEvent(G_dextResizeIcon,"mouseup",function(a){var b=null;G_REMOVE_dextResizeIcon=!1;var c=G_dextResize_OverElem;try{if(c&&"table"==c.nodeName.toLowerCase()){var d=
c.getElementsByTagName("th");d&&0<d.length||(d=c.getElementsByTagName("td"));setFocusChildForStyle(d[0],0);b=getFirstRange().range;DEXTTOP.G_CURREDITOR._LastRange=b}}catch(e){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(e)}null!=DEXTTOP.G_CURREDITOR._LastRange&&restoreSelection(null,!0);DEXTTOP.G_CURREDITOR._config.useMouseTableInoutdent&&(G_dextResize_elem_Rect=getClientRect(c),G_UseMouseTableInoutdent="TABLE"==c.nodeName?!0:!1);resizeHandleClear();G_dextResize_elem=c;clearInterval(dextResizeIconInterval);
for(setResizeHandle(a,!0);c&&c.tagName&&-1<c.tagName.indexOf("DIAGONAL");)c=c.previousSibling;G_CURSOR_ELEMENT=c;"img"==c.nodeName.toLowerCase()&&(G_dextResize_Elem_Flag=!0);DEXTTOP.DEXT5.browser.ie&&9>DEXTTOP.DEXT5.browser.ieVersion&&stopDragElem()}),DEXTTOP.DEXT5.util.addEvent(G_dextResizeIcon,"dragstart",function(a){G_REMOVE_dextResizeIcon=!0;G_dextResizeIcon.parentNode&&(G_dextResizeIcon.parentNode.removeChild(G_dextResizeIcon),clearIfameOverDiv());G_dextResizeIcon=null;clearInterval(dextResizeIconInterval);
dextResizeIconInterval=null;!DEXTTOP.DEXT5.browser.ie||9<DEXTTOP.DEXT5.browser.ieVersion?dragMoveStart(a,G_dextResize_OverElem):DEXTTOP.DEXT5.util.cancelEvent(a)})),G_dextResizeIcon){G_REMOVE_dextResizeIcon=!1;var b=getElementOffset(_iframeWin.frameElement),a=getClientRect(G_dextResize_OverElem),c=0,d;0<=a.left&&(c=b.left+a.left);G_dextResizeIcon.style.left=c+"px";d="img"==G_dextResize_OverElem.nodeName.toLowerCase()?b.top+a.top:b.top+(a.top-13);G_dextResizeIcon.style.top=d+"px"}}catch(e){DEXTTOP&&
DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(e)}};
...
G_dextResizeDivBorder+"px solid transparent";d.style.cursor="move";d.style.zIndex=DEXTTOP.G_CURREDITOR._config.zIndex+100;"div"!=G_dextResize_elem.tagName.toLowerCase()&&"absolute"!=G_dextResize_elem.style.position&&"1"!=DEXTTOP.G_CURREDITOR._config.dragResizeMovable&&(d.style.display="none",G_UseMouseTableInoutdent&&(d.style.display=""));var e=getElementOffset(_iframeWin.frameElement),f=getClientRect(G_dextResize_elem);G_UseMouseTableInoutdent&&0>parseInt(G_dextResize_elem.style.marginLeft)||(d.style.left=
e.left+f.left-G_dextResizeDivBorder+"px");d.style.top=G_UseMouseTableInoutdent?e.top+G_dextResize_elem_Rect.top-G_dextResizeDivBorder+"px":e.top+f.top-G_dextResizeDivBorder+"px";this.setDragResizeDivSize(d);this.setDragResizeDivPosition(d);G_dextResizeHandleHolder=_iframeDoc.createElement("div");G_dextResizeHandleHolder.unSelectable="on";for(e=0;e<handles.length;e++){var g=document.createElement("div");g.className=resizeName+" "+resizeName+"-"+handles[e];g.unSelectable="on";g.style.zIndex=DEXTTOP.G_CURREDITOR._config.zIndex+
101;G_dextResizeHandleHolder.appendChild(g);G_dextResizeHandleHolder[handles[e]]=g}setHandlePosition();var k=getEditorFrameDoc(DEXTTOP.G_CURREDITOR);0==("0"==DEXTTOP.G_CURREDITOR._config.tableUseHeight&&"TABLE"==G_dextResize_elem.tagName)&&k.body.appendChild(G_dextResizeHandleHolder);g=document.createElement("div");g.className="DEXT_fiVe_drag_resizeinfo";g.style.position="absolute";g.style.fontSize="11px";g.style.display="none";g.unSelectable=!0;var h=document.createElement("span");g.appendChild(h);
G_dextResizeHandleHolder.appendChild(g);G_dextResizeHandleHolder.dext_resizeinfo=g;G_dextResizeEditElem&&(DEXTTOP.G_CURREDITOR._config.enterTag=G_orgEnterTag,G_dextResizeEditElem=null);if(G_dextResize_elem.isContentEditable&&-1<G_editIconTagName.indexOf(","+G_dextResize_elem.tagName.toLowerCase()+",")){var m=_iframeDoc.createElement("img");m.id="dextResizeEditIcon";m.src=G_dextResizeEditIconSrc;m.style.zIndex=99999999;m.style.position="absolute";m.style.cursor="pointer";m.style.right="0px";m.style.top=
"0px";d.appendChild(m);G_dextResizeEditIcon=m}k=getEditorFrameDoc(DEXTTOP.G_CURREDITOR);k.body.appendChild(d);G_dextResizeDiv=d;d="dextResize";var n=G_dextResize_elem.tagName.toLowerCase();if("img"==n){var q,p;if(-1<G_dextResize_elem.style.width.indexOf("%")||-1<G_dextResize_elem.style.height.indexOf("%")){var l=getClientRect(G_dextResize_elem);q=l.right-l.left;p=l.bottom-l.top}else""!=G_dextResize_elem.style.width?q=DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.width):(l=getClientRect(G_dextResize_elem),
q=l.right-l.left),""!=G_dextResize_elem.style.height?p=DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.height):(l=getClientRect(G_dextResize_elem),p=l.bottom-l.top);G_ImageR=1*q/p;DEXTTOP.G_SELECTED_IMAGE_ELEMENT=G_dextResize_elem;d=GetParentbyTagName(G_dextResize_elem,"figure")?"focusFigure":"focusImage"}else"table"==n&&(d="focusTable");DEXTTOP.G_CURREDITOR._iconEnable(d);DEXTTOP.DEXT5.util.removeEvent(G_dextResizeDiv,"keydown",keyDown);DEXTTOP.DEXT5.util.addEvent(G_dextResizeDiv,"mousedown",
startDragElem);DEXTTOP.DEXT5.util.addEvent(G_dextResizeHandleHolder,"mousedown",startDragElem)}a&&startDragElem(b,c)}catch(w){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(w)}};
...
"mouseout",ResizeElmOutEvt)}catch(a){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(a)}};
DextDragResize.prototype.removeDextResizeDiv=function(){with(DEXTTOP.G_CURREDITOR.dext_dragresize)try{G_dextResizeDiv&&(G_dextResizeDiv.parentNode&&(DEXTTOP.DEXT5.util.removeEvent(G_dextResizeDiv,"keydown",keyDown),DEXTTOP.DEXT5.util.removeEvent(G_dextResizeDiv,"mousedown",startDragElem),G_dextResizeDiv.parentNode.removeChild(G_dextResizeDiv)),G_dextResizeEditIcon=G_dextResizeDiv=null),G_dextResizeHandleHolder&&(G_dextResizeHandleHolder.parentNode&&(DEXTTOP.DEXT5.util.removeEvent(G_dextResizeHandleHolder,
"mousedown",startDragElem),G_dextResizeHandleHolder.parentNode.removeChild(G_dextResizeHandleHolder)),G_dextResizeHandleHolder=null)}catch(b){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(b)}};
DextDragResize.prototype.startDragElem=function(b,a){with(DEXTTOP.G_CURREDITOR.dext_dragresize)try{DEXTTOP.G_CURREDITOR.isMouseDownOnScrollBar&&(DEXTTOP.G_CURREDITOR.isMouseDownOnScrollBar=!1);var c=b.target||b.srcElement,d=new RegExp(resizeName+"-([trmbl]{2})","");G_setUndo=!1;if(isRightClick(b)){G_dextResize_elem&&(c=G_dextResize_elem);resizeHandleClear();var e=c.tagName.toLowerCase();if("img"==e)selection(c);else if("table"==e){G_dextResize_showContext=!1;var f=getFirstRange();f.sel.removeAllRanges();
G_ResizeHandlerActivatedFlag=!0;G_dextResize_elem=c;_iframeDoc_ContextMenu(b);setTimeout(function(){doSetCaretPosition(getMyFirstOrLastChildElementNode(c),0)},1)}return}if(c==G_dextResizeEditIcon){c=G_dextResize_elem;resizeHandleClear();f=getFirstRange();f.sel.removeAllRanges();"table"==c.tagName.toLowerCase()?(c=getMyFirstOrLastChildElementNode(c),doSetCaretPosition(c,0)):"div"==c.tagName.toLowerCase()&&(G_orgEnterTag=DEXTTOP.G_CURREDITOR._config.enterTag,DEXTTOP.G_CURREDITOR._config.enterTag="br",
G_dextResizeEditElem=c,doSetCaretPosition(c,0));DEXTTOP.DEXT5.util.cancelEvent(b);return}if(d.test(c.className))elmX=parseInt(G_dextResize_elem.style.left),elmY=parseInt(G_dextResize_elem.style.top),elmW=G_dextResize_elem.offsetWidth,elmH=G_dextResize_elem.offsetHeight,G_firstDrag=G_isResize=!0,iframeDocLastMouseY=iframeDocLastMouseX=lastMouseY=lastMouseX=0,handle=c;else{if(G_dextResize_elem&&"TABLE"!=G_dextResize_elem.nodeName&&(G_UseMouseTableInoutdent=!1,"IMG"==G_dextResize_elem.nodeName&&"FIGURE"==
G_dextResize_elem.parentNode.tagName)){DEXTTOP.DEXT5.util.cancelEvent(b);return}if("1"==DEXTTOP.G_CURREDITOR._config.dragResizeMovable||G_UseMouseTableInoutdent||"absolute"==G_dextResize_elem.style.position.toLowerCase())G_isDrag=!0;else if(c.id&&"dextResizeIcon"==c.id){G_dextResize_elem&&"TABLE"==G_dextResize_elem.nodeName&&(G_setUndo=!0);DEXTTOP.DEXT5.util.cancelEvent(b);return}G_firstDrag=!0;G_lastDragY=G_lastDragX=G_dragY=G_dragX=0}DEXTTOP.G_CURREDITOR.dext_dragresize.preventScrollMove();G_REMOVE_dextResizeIcon=
!1;clearInterval(dextResizeIconInterval);clearIfameOverDiv();d=_iframeWin;b||(b=d.event);offsetX=b.clientX;offsetY=b.clientY;G_dextResizeDiv.style.left||(G_dextResizeDiv.style.left="0px");G_dextResizeDiv.style.top||(G_dextResizeDiv.style.top="0px");("1"==DEXTTOP.G_CURREDITOR._config.dragResizeMovable||G_UseMouseTableInoutdent||"absolute"==G_dextResize_elem.style.position.toLowerCase()||G_isResize)&&setDextResizeBackDiv();var g=getElementOffset(_iframeWin.frameElement);"doc"!=a&&(g.left=0,g.top=0);
G_startX=G_UseMouseTableInoutdent?""==G_dextResize_elem.style.marginLeft?0:parseInt(G_dextResize_elem.style.marginLeft):parseInt(G_dextResizeDiv.style.left)+G_dextResizeDivBorder-g.left;G_startY=parseInt(G_dextResizeDiv.style.top)+G_dextResizeDivBorder-g.top;set_ruler_vertical_height(DEXTTOP.G_CURREDITOR);null!=G_dextResizeBackDiv&&DEXTTOP.DEXT5.util.addEvent(G_dextResizeBackDiv,"mousemove",dragElem);DEXTTOP.DEXT5.util.addEvent(document,"mouseup",stopDragElem);onResize({cmd:"start"});"TABLE"==G_dextResize_elem.tagName&&
DEXTTOP.DEXT5.util.cancelEvent(b)}catch(k){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(k)}};
...
DEXTTOP.G_CURREDITOR.UndoManager.putUndo(),G_firstDrag=!1):0==G_UseMouseTableInoutdent&&(G_dextResize_elem.style.position="absolute");if(!(G_UseMouseTableInoutdent&&0>parseInt(G_dextResize_elem.style.marginLeft))){var g=getClientRect(G_dextResize_elem);G_dextResizeDiv.style.left=f.left+g.left-G_dextResizeDivBorder+"px"}G_UseMouseTableInoutdent||(G_dextResizeDiv.style.top=e-G_dextResizeDivBorder+"px");G_dextResizeIcon&&(G_dextResizeIcon.style.left=d+"px","img"==G_dextResize_elem.nodeName.toLowerCase()?
G_dextResizeIcon.style.top=e+"px":G_dextResizeIcon.style.top=e-13+"px");var k=getClientRect(_iframeWin.frameElement),h=getWindowScrollPos(_iframeWin);0==G_UseMouseTableInoutdent&&(isNaN(parseInt(G_dextResize_elem.style.left,10))&&(G_dextResize_elem.style.left=d-k.left+h[0]-getClientRect(G_dextResize_elem).left+"px"),isNaN(parseInt(G_dextResize_elem.style.top,10))&&(G_dextResize_elem.style.top=e-k.top+h[1]-getClientRect(G_dextResize_elem).top+"px"));var m=getParentPosition();if(G_UseMouseTableInoutdent){var n=
d-k.left-m.left;0>n&&(n=-1);if("1"==DEXTTOP.G_CURREDITOR._config.limitTableInoutdent){var c=0,q=getClientRect(G_dextResize_elem);if(""!=_iframeDoc.body.style.width&&-1<_iframeDoc.body.style.width.indexOf("px"))c=DEXTTOP.DEXT5.util.parseIntOr0(_iframeDoc.body.style.width);else{c=_iframeDoc.documentElement.clientWidth;if(0==c||null==c||void 0==c)c=_iframeDoc.body.clientWidth;c=Math.floor(c);c-=20}if(0<c){var p=c-(q.right-q.left);0>p&&(p=0);G_dextResize_elem.style.marginLeft=n<=p?n+1+"px":p+"px"}else G_dextResize_elem.style.marginLeft=
n+1+"px"}else G_dextResize_elem.style.marginLeft=n+1+"px"}else G_dextResize_elem.style.left=d-k.left+h[0]-m.left+"px",G_dextResize_elem.style.top=e-k.top+h[1]-m.top+"px";setHandlePosition()}DEXTTOP.DEXT5.util.stopEvent(b);DEXTTOP.DEXT5.util.cancelEvent(b)}catch(l){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(l)}};
...
10))?0:parseInt(a.style.top,10));return b}catch(c){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(c)}};
DextDragResize.prototype.stopDragElem=function(b){with(DEXTTOP.G_CURREDITOR.dext_dragresize)try{if(G_isDrag||G_isResize||G_setUndo)DEXTTOP.G_CURREDITOR.UndoManager.putUndo(),DEXTTOP.G_CURREDITOR.UndoManager.charCount=0,G_isResize&&G_dextResize_elem&&"table"==G_dextResize_elem.tagName.toLowerCase()&&setResizeHandle(b,!1),DEXTTOP.G_CURREDITOR.dext_dragresize.G_dextResizeDiv&&(DEXTTOP.G_CURREDITOR.dext_dragresize.setDragResizeDivSize(DEXTTOP.G_CURREDITOR.dext_dragresize.G_dextResizeDiv),DEXTTOP.G_CURREDITOR.dext_dragresize.setDragResizeDivPosition(DEXTTOP.G_CURREDITOR.dext_dragresize.G_dextResizeDiv));
G_setUndo=G_firstDrag=G_isDrag=G_ie8Bug=!1;G_dextResizeIcon&&G_dextResizeIcon.parentNode&&(G_dextResizeIcon.parentNode.removeChild(G_dextResizeIcon),G_dextResizeIcon=null);dextResizeIconInterval&&(clearInterval(dextResizeIconInterval),dextResizeIconInterval=null);G_dextResize_OverElem&&(DEXTTOP.DEXT5.util.removeEvent(G_dextResize_OverElem,"mouseout",ResizeElmOutEvt),"FIGURE"==G_dextResize_OverElem.nodeName&&0==G_isResize&&removeDextResizeDiv());DEXTTOP.DEXT5.util.removeEvent(document,"mouseup",stopDragElem);
removeDextResizeBackDiv();set_ruler_vertical_height(DEXTTOP.G_CURREDITOR)}catch(a){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(a)}};
...
9>DEXTTOP.DEXT5.browser.ieVersion?(G_dextResizeBackDiv.style.background="gray",G_dextResizeBackDiv.style.filter="alpha(opacity=5)"):DEXTTOP.DEXT5.browser.ie&&(G_dextResizeBackDiv.style.background="white",G_dextResizeBackDiv.style.opacity="0.1"),getEditorFrameDoc(DEXTTOP.G_CURREDITOR).body.appendChild(G_dextResizeBackDiv))}catch(b){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(b)}};
DextDragResize.prototype.elementResize=function(b,a){with(this)try{if(!G_dextResizeDiv)return;try{9==getFirstRange().range.startContainer.nodeType&&restoreSelection(DEXTTOP.G_CURREDITOR._LastRange)}catch(c){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(c)}mouseX=b.pageX||b.clientX+document.documentElement.scrollLeft;mouseY=b.pageY||b.clientY+document.documentElement.scrollTop;handle&&"top"==a?(topMouseX||(topMouseX=mouseX,topMouseY=mouseY,docMouseY=docMouseX=null),0==docLastMouseX&&(docLastMouseX=
lastMouseX),0==docLastMouseY&&(docLastMouseY=lastMouseY),mouseX=docLastMouseX+(mouseX-topMouseX),mouseY=docLastMouseY+(mouseY-topMouseY),iframeDocLastMouseX=mouseX,iframeDocLastMouseY=mouseY):handle&&"doc"==a&&(docMouseX||(docMouseX=mouseX,docMouseY=mouseY,topMouseY=topMouseX=null),mouseX=iframeDocLastMouseX+(mouseX-docMouseX),mouseY=iframeDocLastMouseY+(mouseY-docMouseY),docLastMouseX=mouseX,docLastMouseY=mouseY);var d=mouseX-lastMouseX+mOffX,e=mouseY-lastMouseY+mOffY;mOffX=mOffY=0;lastMouseX=mouseX;
lastMouseY=mouseY;!a&&handle&&(iframeDocLastMouseX=mouseX,iframeDocLastMouseY=mouseY);if(!handle)return!0;G_firstDrag&&(0<DEXTTOP.G_CURREDITOR.UndoManager.charCount&&DEXTTOP.G_CURREDITOR.UndoManager.putUndo(),G_firstDrag=!1);var f=!1;if(this.resizeHandleDrag&&this.resizeHandleDrag(d,e))f=!0;else{var g=d,k=e;elmX+g<minLeft?mOffX=g-(d=minLeft-elmX):elmX+elmW+g>maxLeft&&(mOffX=g-(d=maxLeft-elmX-elmW));elmY+k<minTop?mOffY=k-(e=minTop-elmY):elmY+elmH+k>maxTop&&(mOffY=k-(e=maxTop-elmY-elmH));elmX+=d;elmY+=
e}if(f){var h=getElementBorderWidth(),m=DEXTTOP.DEXT5.util.parseIntOr0(h.borderTopWidth)+DEXTTOP.DEXT5.util.parseIntOr0(h.borderBottomWidth),n=DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.paddingTop)+DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.paddingBottom),q=G_dextResize_elem.style.width,p=G_dextResize_elem.style.height,l,f=0,w,x,y,g=0;if(-1<q.indexOf("%")||-1<p.indexOf("%")){var r=getClientRect(G_dextResize_elem);l=DEXTTOP.DEXT5.util.parseIntOr0(r.right-r.left);f=DEXTTOP.DEXT5.util.parseIntOr0(r.bottom-
r.top);q&&-1<q.indexOf("%")&&(x=l,w=DEXTTOP.DEXT5.util.parseFloatOr0(q).toFixed(2));p&&-1<p.indexOf("%")&&(g=f,y=DEXTTOP.DEXT5.util.parseFloatOr0(p).toFixed(2))}else if(l=DEXTTOP.DEXT5.util.parseIntOr0(q,10),f=DEXTTOP.DEXT5.util.parseIntOr0(p,10),0==l||0==f)r=getClientRect(G_dextResize_elem),0==l&&(l=DEXTTOP.DEXT5.util.parseIntOr0(r.right-r.left)),0==f&&(f=DEXTTOP.DEXT5.util.parseIntOr0(r.bottom-r.top));var t=handle&&handle.className&&handle.className.match(new RegExp(resizeName+"-([tmblr]{2})"))?
RegExp.$1:"";if("IMG"==G_dextResize_elem.tagName&&(-1<t.indexOf("br")||-1<t.indexOf("bl")||-1<t.indexOf("tl")||-1<t.indexOf("tr")))l=parseInt(elmW,10)-(m+n),f=parseInt(elmH,10)-(m+n),-1<q.indexOf("%")&&-1<p.indexOf("%")?setNodeWidthHeight(G_dextResize_elem,{width:DEXTTOP.DEXT5.util.parseFloatOr0(w*l/x).toFixed(2)+"%",height:DEXTTOP.DEXT5.util.parseFloatOr0(y*f/g).toFixed(2)+"%"}):-1<q.indexOf("%")?(setNodeWidthHeight(G_dextResize_elem,{width:DEXTTOP.DEXT5.util.parseFloatOr0(w*l/x).toFixed(2)+"%"}),
""!=p&&setNodeWidthHeight(G_dextResize_elem,{height:f+"px"})):-1<p.indexOf("%")?(setNodeWidthHeight(G_dextResize_elem,{height:DEXTTOP.DEXT5.util.parseFloatOr0(y*f/g).toFixed(2)+"%"}),""!=q&&setNodeWidthHeight(G_dextResize_elem,{width:l+"px"})):setNodeWidthHeight(G_dextResize_elem,{width:l+"px",height:DEXTTOP.DEXT5.util.parseIntOr0(1*l/G_ImageR)+"px"});else{if(0<=t.indexOf("l")||0<=t.indexOf("r"))l=parseInt(elmW,10)-(m+n),-1<q.indexOf("%")?setNodeWidthHeight(G_dextResize_elem,{width:DEXTTOP.DEXT5.util.parseFloatOr0(w*
l/x).toFixed(2)+"%"}):setNodeWidthHeight(G_dextResize_elem,{width:l+"px"}),(""==G_dextResize_elem.style.height||G_dextResize_elem.getAttribute("height")||""==G_dextResize_elem.getAttribute("height"))&&setNodeWidthHeight(G_dextResize_elem,{height:f+"px"});if(0<=t.indexOf("t")||0<=t.indexOf("b"))f=parseInt(elmH,10)-(m+n),-1<p.indexOf("%")?setNodeWidthHeight(G_dextResize_elem,{height:DEXTTOP.DEXT5.util.parseFloatOr0(y*f/g).toFixed(2)+"%"}):setNodeWidthHeight(G_dextResize_elem,{height:f+"px"}),(""==G_dextResize_elem.style.width||
G_dextResize_elem.getAttribute("width")||""==G_dextResize_elem.getAttribute("width"))&&setNodeWidthHeight(G_dextResize_elem,{width:l+"px"})}"1"==DEXTTOP.G_CURREDITOR._config.dragResizeMovable&&(G_dextResize_elem.style.left=parseInt(elmX,10)+"px",G_dextResize_elem.style.top=parseInt(elmY,10)+"px");m=!1;n=[];if("table"==G_dextResize_elem.tagName.toLowerCase()){for(var m=!0,r=G_dextResize_elem,K=DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.width,10),L=DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.height,
10),k=0,H=r.rows.length,h=0;h<H;h++)var A=r.rows[h],k=k+parseFloat(getClientRect(A.cells[0]).height);for(h=0;h<H;h++){for(var A=r.rows[h],C=A.cells.length,I=0==h,B=0,u=0;u<C;u++)var v=A.cells[u],B=B+parseFloat(getClientRect(v).width);if((0<=t.indexOf("l")||0<=t.indexOf("r"))&&K!=B)for(B=(B-K)/C,u=0;u<C;u++){var v=A.cells[u],J=Math.floor(100*parseFloat(parseFloat(v.style.width.replace("px",""))-B+parseFloat(d/C)))/100;v.style.width=J+"px";v.width&&(v.width=J);if(I&&G_dextResize_elem.style.tableLayout&&
"fixed"==G_dextResize_elem.style.tableLayout){var M=G_dextResize_elem.getElementsByTagName("colgroup");if(0<M.length){var P=M[0].getElementsByTagName("col");n.push({col:P[u],width:J})}}}if((0<=t.indexOf("t")||0<=t.indexOf("b"))&&L!=k)for(I=(k-L)/H,u=0;u<C;u++){var v=A.cells[u],N=Math.floor(100*parseFloat(parseFloat(v.style.height.replace("px",""))-I+parseFloat(e/H)))/100;v.style.height=N+"px";v.height&&(v.height=N)}}}setHandlePosition();for(d=0;d<n.length;d++)n[d].col.style.width=n[d].width+"px",
n[d].col.width=n[d].width;G_dextResizeHandleHolder.dext_resizeinfo.style.display="";G_dextResizeHandleHolder.dext_resizeinfo.style.zIndex=1E6;G_dextResizeHandleHolder.dext_resizeinfo.style.top=handle.offsetTop+"px";G_dextResizeHandleHolder.dext_resizeinfo.style.left=handle.offsetLeft+"px";G_dextResizeHandleHolder.dext_resizeinfo.firstChild&&G_dextResizeHandleHolder.dext_resizeinfo.removeChild(G_dextResizeHandleHolder.dext_resizeinfo.firstChild);var D=document.createElement("span"),E=DEXTTOP.DEXT5.util.parseIntOr0(getNodeWidthHeight(G_dextResize_elem,
"width"),10),z=DEXTTOP.DEXT5.util.parseIntOr0(getNodeWidthHeight(G_dextResize_elem,"height"),10);if(7!=DEXTTOP.DEXT5.browser.ieVersion){var F=getNodeWidthHeight(G_dextResize_elem,"maxWidth");""!=F&&(F=DEXTTOP.DEXT5.util.parseIntOr0(F,10),E=E>F?F:E);var G=getNodeWidthHeight(G_dextResize_elem,"maxHeight");""==G||m||(G=DEXTTOP.DEXT5.util.parseIntOr0(G,10),z=z>G?G:z)}if(0==z)var O=getClientRect(G_dextResize_elem),z=DEXTTOP.DEXT5.util.parseIntOr0(O.bottom-O.top);-1<q.indexOf("%")&&-1<p.indexOf("%")?D.innerHTML=
DEXTTOP.DEXT5.util.parseIntOr0(w*l/x)+"% X "+DEXTTOP.DEXT5.util.parseIntOr0(y*f/g)+"%":-1<q.indexOf("%")?D.innerHTML=""==p?DEXTTOP.DEXT5.util.parseFloatOr0(w*l/x).toFixed(2)+"%":DEXTTOP.DEXT5.util.parseIntOr0(w*l/x)+"% X "+z:-1<p.indexOf("%")?D.innerHTML=""==q?DEXTTOP.DEXT5.util.parseFloatOr0(y*f/g).toFixed(2)+"%":E+" X "+DEXTTOP.DEXT5.util.parseIntOr0(y*f/g)+"%":D.innerHTML=E+" X "+z;G_dextResizeHandleHolder.dext_resizeinfo.appendChild(D)}G_dextResizeDiv&&(this.setDragResizeDivPosition(G_dextResizeDiv),
this.setDragResizeDivSize(G_dextResizeDiv));DEXTTOP.DEXT5.util.cancelEvent(b)}catch(Q){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(Q)}};
...
1);return b}catch(a){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(a)}};
...
e-(b=elmW-minWidth):elmX+e<minLeft&&(mOffX=e-(b=minLeft-elmX)),elmX+=b,elmW-=b,f=!0);0<=c.indexOf("r")&&(rs=1,elmW+e<minWidth?mOffX=e-(b=minWidth-elmW):elmX+elmW+e>maxLeft&&(mOffX=e-(b=maxLeft-elmX-elmW)),elmW+=b,f=!0);return f}catch(g){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(g)}};
DextDragResize.prototype.mouseUp=function(b){with(this)try{if(isRightClick(b)||checkClickOnScrollBar(b)||DEXTTOP.G_CURREDITOR.isMouseDownOnScrollBar)return;var a=!0;try{if(0==G_isResize){var c=b.target?b.target:b.srcElement;if(c){var d=null,e=null;9!=c.nodeType&&(d=c.ownerDocument);(e=getDocWindow(d).frameElement)?0!=e.id.indexOf("dext_frame_")&&0!=e.id.indexOf("dext5_design_")&&(a=!1):a=!1}}}catch(f){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(f)}if(0==a){resizeHandleClear();return}if(G_dextResize_elem&&
"img"==G_dextResize_elem.tagName.toLowerCase()&&"absolute"!=G_dextResize_elem.style.position){var g,k;if(-1<G_dextResize_elem.style.width.indexOf("%")||-1<G_dextResize_elem.style.height.indexOf("%")){var h=getClientRect(G_dextResize_elem);g=h.right-h.left;k=h.bottom-h.top}else""!=G_dextResize_elem.style.width?g=DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.width):(h=getClientRect(G_dextResize_elem),g=h.right-h.left),""!=G_dextResize_elem.style.height?k=DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.height):
(h=getClientRect(G_dextResize_elem),k=h.bottom-h.top);G_ImageR=1*g/k;var m=G_dextResize_elem.parentNode;if(!DEXTTOP.DEXT5.browser.chrome&&!DEXTTOP.DEXT5.browser.opera){if(G_dextResize_elem.parentNode.tagName&&"figure"==G_dextResize_elem.parentNode.tagName.toLowerCase()){var n=G_dextResize_elem.parentNode.getElementsByTagName("figcaption");n&&n[0]&&(m=getMyFirstOrLastChildElementNode(n[0]),rangy.getSelection(_iframeWin).removeAllRanges(),doSetCaretPosition(m,0))}DEXTTOP.DEXT5.browser.ie&&9>DEXTTOP.DEXT5.browser.ieVersion&&
(DEXTTOP.G_CURREDITOR.dext_dragresize.preventScrollMove(),doSetCaretPosition(m,0))}}G_dextResize_elem&&G_dextResize_elem.getAttribute("raon_chart")&&G_dextResize_elem.setAttribute("raon_plugin","chart");onChange({editor:DEXTTOP.G_CURREDITOR,isPossibleDirty:!0});stopDragElem();DEXTTOP.G_CURREDITOR.dext_dragresize.removePreventScrollMove();onResize({cmd:"end",event:b,target:G_dextResize_elem,isResize:G_isResize});deselect(!1);G_isResize=!1;if("1"==DEXTTOP.G_CURREDITOR._config.returnEvent.mouse_event){DEXTTOP.DEXT5.config.MouseEventCancel=
!1;try{"function"===typeof DEXTTOP.G_CURREDITOR._config.event.mouse?DEXTTOP.G_CURREDITOR._config.event.mouse("mouseup",b,G_dextResize_elem):"function"===typeof DEXTTOP.DEXTWIN.dext_mouse_event&&DEXTTOP.DEXTWIN.dext_mouse_event("mouseup",b,G_dextResize_elem)}catch(q){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(q)}if(1==DEXTTOP.DEXT5.config.MouseEventCancel){DEXTTOP.DEXT5.util.cancelEvent(b);return}}docMouseY=docMouseX=topMouseY=topMouseX=null}catch(p){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&
console.log(p)}};DextDragResize.prototype.deselect=function(b){with(this)try{G_dextResizeHandleHolder&&(G_dextResizeHandleHolder.dext_resizeinfo.style.display="none",G_dextResizeHandleHolder.dext_resizeinfo.innerHTML=""),handle=null,mOffY=mOffX=0}catch(a){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(a)}};
DextDragResize.prototype.resizeHandleClear=function(){with(this)try{if(1==G_ResizeHandlerActivatedFlag){G_ResizeHandlerActivatedFlag=!1;return}stopDragElem();clearIfameOverDiv();removeDextResizeDiv();G_mouseOveriframeObj=G_dextResize_elem=G_dextResizeIcon=G_dextResize_OverElem=null}catch(b){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(b)}};
DextDragResize.prototype.clearIfameOverDiv=function(){with(DEXTTOP.G_CURREDITOR.dext_dragresize)try{G_dextIframeOverDiv&&G_dextIframeOverDiv.parentNode&&(DEXTTOP.DEXT5.util.removeEvent(G_dextIframeOverDiv,"mousedown",ifameOverDivClick),G_dextIframeOverDiv.parentNode.removeChild(G_dextIframeOverDiv)),G_dextIframeOverDiv=null}catch(b){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(b)}};
DextDragResize.prototype.removeDextResizeBackDiv=function(){with(DEXTTOP.G_CURREDITOR.dext_dragresize)try{G_dextResizeBackDiv&&(G_dextResizeBackDiv.parentNode&&(DEXTTOP.DEXT5.util.removeEvent(G_dextResizeBackDiv,"mousemove",dragElem),G_dextResizeBackDiv.parentNode.removeChild(G_dextResizeBackDiv)),G_dextResizeBackDiv=null)}catch(b){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(b)}};
...
d||67==d)||46==d||8==d){resizeHandleClear();var e=a.tagName.toLowerCase();if((46==d||8==d)&&-1<G_deleteCheckTagName.indexOf(","+e+",")){if("table"!=e){var f=getFirstRange().sel,g=getFirstRange().range;g.setStartBefore(a);g.setEndBefore(a);f.removeAllRanges();f.addRange(g)}a.parentNode.removeChild(a);DEXTTOP.DEXT5.util.cancelEvent(b)}else{if("img"==e){var k=GetParentbyTagName(a,"figure");if(k&&(a=k,46==d||8==d)){a.parentNode.removeChild(a);DEXTTOP.DEXT5.util.cancelEvent(b);return}}selection(a)}}else(c&&
90==d||89==d||!c)&&resizeHandleClear();removePreventScrollMove()}catch(h){DEXTTOP&&DEXTTOP.DEXT5&&DEXTTOP.DEXT5.logMode&&console.log(h)}};
